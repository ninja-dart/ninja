...
-----END PRIVATE KEY-----''';
    ...
    test('privatekey.pkcs1', () {
      final privateKey = RSAPrivateKey.fromPEM(privateKeyPkcs1);
      final encoded = privateKey.toPem(toPkcs1: true);
      expect(encoded, privateKeyPkcs1);
    });

    test('privatekey.pkcs8', () {
      final privateKey = RSAPrivateKey.fromPEM(privateKeyPkcs8);
      final encoded = privateKey.toPem(toPkcs1: false);
      expect(encoded, privateKeyPkcs8);
    });
  });
}
